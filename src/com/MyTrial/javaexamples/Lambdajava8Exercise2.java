...
public class Lambdajava8Exercise2 {
...

    {
        ...
        PrintContionally(humans,p -> true,System.out::println);// here is the change we made( if any doubt , please check previous programme
